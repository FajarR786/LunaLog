        ...
        NavigationStack {
            VStack {
                ...
                Text("Challenges You Might Have Faced")
                    .fontWeight(.semibold)
                Text("Late sleepers tend to find it difficult waking up early, usually missing out on morning opportunities, may face life conflicts due to sleeping habits, and may pertain to serous health issues such as poor diet and lack of exercise.")
                Spacer()
                    .frame(height: 20.0)
                ...
                Spacer()
                    .frame(height: 15.0)
                Button("Gradually adjust you sleep times to be earlier") {
